...
from .api_views import (
    ...
    PublicLandingDataAPIView, AnnouncementViewSet, EnrollmentInfoViewSet,
    ProgramHighlightViewSet, PublicReminderViewSet, TeacherStudentMapAPIView,
    CenterSettingsAPIView, TextblastSendAPIView, TextblastHistoryAPIView
)
...
router.register(r'enrollment-info', EnrollmentInfoViewSet, basename='enrollment_info')
router.register(r'program-highlights', ProgramHighlightViewSet, basename='program_highlight')
router.register(r'public-reminders', PublicReminderViewSet, basename='public_reminder')
...
urlpatterns = [
    ...
    path('student-map/', views.teacher_student_map, name='teacher_student_map'),
    path('textblast/', views.teacher_textblast, name='teacher_textblast'),
    ...
    path('parent/map-route/', views.parent_map_route, name='parent_map_route'),
    ...
    path('api/public/landing-data/', PublicLandingDataAPIView.as_view(), name='api_public_landing_data'),
    ...
    path('api/center-settings/', CenterSettingsAPIView.as_view(), name='api_center_settings'),
    path('api/teacher/student-map/', TeacherStudentMapAPIView.as_view(), name='api_teacher_student_map'),
    path('api/textblast/send/', TextblastSendAPIView.as_view(), name='api_textblast_send'),
    path('api/textblast/history/', TextblastHistoryAPIView.as_view(), name='api_textblast_history'),
