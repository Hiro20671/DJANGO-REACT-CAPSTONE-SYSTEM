...
from .models import (Child, AttendanceRecord, MilestoneRecord, NutritionRecord, SchoolYear, 
                     EngagementRecord, ECCDDomain, ECCDMilestone, ECCDAssessment, ECCDMilestoneScore, BMIRecord, CenterSettings, TextblastLog)
...
class AnnouncementSerializer(serializers.ModelSerializer):
    created_by_username = serializers.ReadOnlyField(source='created_by.user.username')
...
class PublicReminderSerializer(serializers.ModelSerializer):
    class Meta:
        model = PublicReminder
        fields = '__all__'
...
class TextblastLogSerializer(serializers.ModelSerializer):
